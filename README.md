...
## Prom Email Notification

The project is configured to send an EmailJS notification when the Yes button is clicked.
The browser uses the EmailJS public key, service ID, and template ID configured in `script.js`.
Do not add an EmailJS private key to the website.
